...
| --- | --- | --- | --- |
| `NEW_API_KEY` | yes | none | API key for the OpenAI-compatible endpoint |
| `NEW_API_BASE_URL` | no | `https://api.openai.com/v1` | Base URL, must include `/v1` |
...
- `NEW_API_BASE_URL` must already include `/v1`.
